...
const soundList = [
    { name: 'Bump.mp3', path: 'SoundEffects/Bump.mp3' },
    { name: 'Fireball.mp3', path: 'SoundEffects/Fireball.mp3' },
    { name: 'Kick.mp3', path: 'SoundEffects/Kick.mp3' },
    { name: 'Pipe.mp3', path: 'SoundEffects/Pipe.mp3' },
    { name: 'Squish.mp3', path: 'SoundEffects/Squish.mp3' },
    { name: 'tail.mp3', path: 'SoundEffects/tail.mp3' },
    { name: 'Death.mp3', path: 'SoundEffects/Death.mp3' },
    { name: 'Item Box.mp3', path: 'SoundEffects/Item Box.mp3' },
    { name: 'Mario Jump.mp3', path: 'SoundEffects/Mario Jump.mp3' },
    { name: 'Powerup.mp3', path: 'SoundEffects/Powerup.mp3' },
    { name: 'Transformation.mp3', path: 'SoundEffects/Transformation.mp3' },
    { name: 'Coin.mp3', path: 'SoundEffects/Coin.mp3' }
    ...
    try {
        ...
        if (parsedMessage.type === 'moveImage') {
           ...
           //Example { "type": "setVisible", "imageId": "12", "bool":"true" } 
            ...
            const queryString = `lobbyId=${encodeURIComponent(queryParams.lobbyId)}&errMsg=lobbyFull`;
            const url = `index.html?${queryString}`;
            window.location.href = url;
        } else if (parsedMessage.type === 'lobbyAlreadyStarted') {
             // GO BACK TO INDEX.HTML to try joining another lobby, one that hasn't started
            const queryString = `lobbyId=${encodeURIComponent(queryParams.lobbyId)}&errMsg=lobbyStarted`;
            const url = `index.html?${queryString}`;
            window.location.href = url;
        } else {
